$(document).ready(function() {/*DNT*/
  ...
  $('.btn-info').click(function() {
    Swal.fire({
        title: '🌟 Ultimate Tic Tac Toe Fun!',
        html: 'Welcome to the game! 🎉<br><br>' +
              'Objective: Be the first to win three in a row on the big board! 🏆<br><br>' +
              'Quick Rules:<br>' +
              '1. Each small 3x3 board is a game. 🕹️<br>' +
              '2. Win a small board, claim its spot on the big board. 🏅<br>' +
              '3. Your move picks the next board for your opponent. 🔄<br>' +
              '4. If sent to a won board, play anywhere. 🚀<br>' +
              '5. Outsmart your opponent, plan your moves! 🤔<br><br>' +
              'Get ready for some strategic fun! 🚀<br><br>' +
